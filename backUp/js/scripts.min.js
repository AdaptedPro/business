...
r.enable=function(){
	if(!this.enabled){
		for(var a,b=0,c=this.ia.length;b<c;b++)a=this.ia[b],a.x+=(Math.random()-0.5)*100,a.y+=(Math.random()-0.5)*100;
...
r.disable=function(){
	this.enabled&&(this.k.unbind("mousemove",this.f.Oa),
			this.K.disable.call(this))
};
...
AdaptedPro.aa=function(){
	var a=$("#sections"),b=$("#discussion");
		b.find(".content");
	var c=b.find(".toggle");
	return {
		refresh:function(){
			typeof DISQUS!=="undefined"&&DISQUS.reset({
				reload:!0,Ic:function(){
		...
		close:function(){
			...
			init:function(){
				c.bind("click",function(){
					b.hasClass("closed")?AdaptedPro.aa.open():AdaptedPro.aa.close();
					return!1
				});
				(function(){
					var a=document.createElement("script");
						...
						a.async=!0;
						a.src="http://AdaptedPro.disqus.com/embed.js";
						(document.getElementsByTagName("head")[0]||document.getElementsByTagName("body")[0]).appendChild(a)
				})();
				var a=setInterval(function(){
					typeof DISQUS!=="undefined"&&(clearInterval(a),b.hasClass("disabled")||AdaptedPro.aa.refresh())
				},100);
				AdaptedPro.Q.bind("enableComments",AdaptedPro.aa.enable,AdaptedPro.aa);
				AdaptedPro.Q.bind("disableComments",AdaptedPro.aa.disable,AdaptedPro.aa)
			}
	}
}();
AdaptedPro.ta=function(a){
	this.enabled=!0;
	this.k=a;
	this.$=a.find("ul");
	this.v=a.find("li");
	...
	this.position=0;
	this.f={
			next:$.proxy(this.next,this),prev:$.proxy(this.prev,this)};
	this.init()
};

AdaptedPro.ta.prototype.init=function(){
	this.fa.append(this.pa);
	this.fa.append(this.oa);
	this.k.append(this.fa);
	var a=this.Yb,b=a?this.$.height():this.$.width();
	this.v.each(function(c){
		$(this).css(a?{top:c*b}:{left:c*b})
	});
	this.oa.bind("click",this.f.next);
	this.pa.bind("click",this.f.prev)
};

AdaptedPro.ta.prototype.ka=function(a){
	if(this.enabled){
		this.position=a<0?this.Rb-1:a>this.Rb-1?0:a;
		var b=this,a=this.Yb?{
...
AdaptedPro.ta.prototype.next=function(){
	this.ka(this.position+1);
	return!1
};

AdaptedPro.ta.prototype.prev=function(){
	this.ka(this.position-1);
	return!1
};

AdaptedPro.Ia=function(a){
	this.enabled=!0;
	this.Sa=h;
	this.k=a;
	...
	this.cb=this.v.outerHeight(!0);this.ua=[];
	this.f={
...
r.init=function(){
	...
	c.sort(!1);
	setTimeout(function(){
		for(var a=0,b=c.ua.length;a<b;++a)c.ua[a]()
	},1);
	$(this.Sa[0]).css({opacity:0}).animate({opacity:1},{duration:350});
	this.v.each(function(b){
		a=$(this);
		a.hasClass("disabled")||a.css({opacity:0}).stop().delay(b*150).animate({opacity:1},
				{duration:350})
	})
};
...
r.sort=function(a){
	if(this.q<0||this.q>this.v.length-1)
		this.q=Math.max(this.q,0),this.q=Math.min(this.q,this.v.length-1);
	else{
		typeof a==="undefined"&&(a=!0);
		var b,c,d,e,f=this,g=this.q>this.jb;
		this.v.each(function(i){
			b=$(this);
			c=i-(f.q-f.Kb);
			e=c>f.Wb||c<-f.Xb;
			d=f.pb+f.cb*(c*=e?1.25:1);
			i===f.jb&&(g?b.addClass("static").css({top:f.pb}):b.addClass("static").css({top:f.Dc-f.cb}));
			if(i>f.q||i===f.q&&g)d+=f.Zb-f.cb+f.pc;
			e?b.addClass("disabled"):b.removeClass("disabled");
			if(i===f.q)f.C=b;a?(e||g&&c>=f.Wb||!g&&c<=-f.Xb?b.addClass("offset"):b.removeClass("offset"),f.Gb(f.move,1,b,d,e)):b.addClass("static").css({opacity:e?0:1,top:d})});
		this.Sa.each(function(e){
			b=$(this);
			c=e-(f.q-f.Kb);
			d=b.height()*c;
			a?f.Gb(f.move,1,b,d,!1):b.addClass("static").css({top:d})
		});
		this.jb=this.q;
		for(var j=0,m=this.ua.length;j<m;++j)this.ua[j]()}};
		r.la=function(a){
			this.ua.push(a)};
			r.move=function(a,b,c){
				a.removeClass("static").css({opacity:c?0:1,top:b})
			};
			r.ka=function(a){this.q=a;this.sort()};
			r.next=function(){
				this.ka(this.q+1);
				return!1
			};
			...
			AdaptedPro.ca=function(){
				var a=h;
				return{
					sa:"http://api.twitter.com/1/statuses/user_timeline.json?screen_name=AdaptedPro&count=100",
					qa:"jsonp",
					ra:6E5,
					getData:function(b){
						if(a&&(new Date).getTime()- -1<AdaptedPro.ca.ra)b&&b.call(AdaptedPro.ca,a);
						else{var c={};c.url=AdaptedPro.ca.sa;c.dataType=AdaptedPro.ca.qa;c.error=k();
						c.success=function(c){
							AdaptedPro.ca.Nb=(new Date).getTime();b&&(a=c,b.call(AdaptedPro.ca,c))};$.ajax(c)
						}
					}
				}
			}();
			
			AdaptedPro.da=function(){
				var a=h;
				return{
					sa:"http://blog.AdaptedPro.co.uk/feed/?feed=json&jsonp=?",
					qa:"jsonp",
					ra:6E5,getData:function(b){
						if(a&&(new Date).getTime()- -1<AdaptedPro.da.ra)b&&b.call(AdaptedPro.da,a);
						else{var c={};
							c.url=AdaptedPro.da.sa;
							c.dataType=AdaptedPro.da.qa;
							c.error=k();
							c.success=function(c){
								AdaptedPro.da.Nb=(new Date).getTime();
								b&&(a=c,b.call(AdaptedPro.da,c))
							};
							$.ajax(c)
						}
					}
			...
			AdaptedPro.ba=function(){
				...
				return{
					...
					ra:6E5,
					getData:function(b){
						if(a&&(new Date).getTime()- -1<AdaptedPro.ba.ra)b&&b.call(AdaptedPro.ba,a);
						else{
							var c={};
							c.url=AdaptedPro.ba.sa;
							c.dataType=AdaptedPro.ba.qa;
							c.error=k();
							c.success=function(c){
								AdaptedPro.ba.Nb=(new Date).getTime();
								b&&(a=c,b.call(AdaptedPro.ba,c))
							};
							$.ajax(c)
						}
					}
			...
			AdaptedPro.Va.prototype.init=function(){
				var a=this;
				AdaptedPro.Q.bind("KONAMI",function(){
					for(var b=a.Ta-a.Ha,c=a.Ta*4,d=0;d<b;d++)
						a.Na[d]=new Image,a.Na[d].src="http://placekitten.com/g/"+c+"/"+(c+d);
						a.Ib=!0;
						AdaptedPro.ha.Ma.X.y=-120
				});
				var b,c,d,e,f,g=[];
				...
				for(b=0;b<this.ga;b++)
					...
					f=this.Ha+c*(this.Ta-this.Ha),
					c=this.Ab+c*(this.ec-this.Ab),
					this.J[b]=new AdaptedPro.Ua(d,e,c,f),
					this.Ya[b]=g.concat()
			};
				
			AdaptedPro.Va.prototype.update=function(a){
				var b,c,d,e;
				e=this.width;
				d=this.height;
				for(b=0;b<this.ga;b++)
					...
					c.x+=c.Tb*a.x,
					c.y+=c.Tb*a.y,
					c.x=c.x<-c.R?e+c.R:c.x>e+c.R?-c.R:c.x,
					c.y=c.y<-c.R?d+c.R:c.y>d+c.R?-c.R:c.y;
					for(b=0;b<this.ga;b++){
						c=this.J[b];
						for(a=b+1;a<this.ga;a++)
							d=this.J[a],
							e=c.x-d.x,
							d=c.y-d.y,
							e=e*e+d*d,
	...
	for(d=0;d<a.ga;d++){
		...
		for(e=d+1;e<a.ga;e++)
			if((j=a.Ya[d][e])!==!1)
				...
				b.moveTo(f.x,f.y),
				b.lineTo(g.x,g.y),
				b.globalAlpha=j*1.5*c,
				b.strokeStyle="#FFF",
				b.lineWidth=1,b.stroke();
		a.Ib?(e=f.R*2,b.save(),
				b.globalAlpha=1,
				b.beginPath(),
				b.arc(f.x,f.y,e,0,Math.PI*2,!1),
				b.closePath(),
				b.clip(),
				b.drawImage(a.Na[f.id%a.Na.length],
						f.x-e,f.y-e),
						b.restore()):(b.beginPath(),
								b.arc(f.x,f.y,f.R,0,Math.PI*2,!1),
								b.closePath(),
								b.strokeStyle=f.Eb,
								b.globalAlpha=0.25*c,
								b.lineWidth=f.R*a.Ha*0.5,
								b.stroke(),
								b.globalAlpha=0.8*c,
								b.fillStyle=f.Eb,
								b.fill())
...
AdaptedPro.Ua=function(a,b,c,d,e){
	this.x=a||0;
	this.y=b||0;
	this.Tb=c||1;
	this.R=d||5;
	this.Eb=e||"#FFF";
	this.id=AdaptedPro.Ua.dc++
};

AdaptedPro.Ua.dc=0;

AdaptedPro.ha=function(){
	if(AdaptedPro.ha.Ma)
		return AdaptedPro.ha.Ma;
	AdaptedPro.ha.Ma=this;
...
r=AdaptedPro.ha.prototype;

r.init=function(a){
	AdaptedPro.Q.bind("ambienceStop",this.f.stop);
	AdaptedPro.Q.bind("ambienceStart",this.f.start);
	var b;
	this.k=a;
	this.k.append(this.tb);
	this.resize(h);
	this.J=new AdaptedPro.Va(this.width,this.height);
	a=$("#sections, .scroll-x");
...
r.start=function(){
	if(!this.enabled)this.enabled=!0,this.update()
};
...
r.update=function(){
	if(this.enabled){
		if(Math.abs(this.X.x)>0.01||Math.abs(this.X.y)>0.01)
			switch(this.loop=(this.loop+1)%4,this.loop){
				case 0:
...
Date.va={
		...
		D:function(a){
			return Date.va.Bc[a.getDay()]},j:function(a){
				return a.getDate()
			},
		l:function(a){
			return Date.va.rc[a.getDay()]
		},
		N:function(a){
			return a.getDay()+1
		},
		S:function(a){
			return a.getDate()%10==1&&a.getDate()!=11?"st":a.getDate()%10==2&&a.getDate()!=12?"nd":a.getDate()%10==3&&a.getDate()!=13?"rd":"th"
		},
		w:function(a){
			return a.getDay()
		},
		z:function(a){
			return Math.ceil((this-new Date(a.getFullYear(),0,1))/864E5)
		},
		W:function(a){
		...
		F:function(a){
			return Date.va.sc[a.getMonth()]
		},
		m:function(a){
			return(a.getMonth()<9?"0":"")+(a.getMonth()+1)
		},
		M:function(a){
			return Date.va.Cc[a.getMonth()]
		},
		n:function(a){
			return a.getMonth()+1
		},
		...
		B:function(a){
			return Math.floor(((a.getUTCHours()+1)%24+a.getUTCMinutes()/60+a.getUTCSeconds()/3600)*1E3/24)
		},
		g:function(a){
		...
		h:function(a){
			return((a.getHours()%12||12)<10?"0":"")+(a.getHours()%12||12)
		},
		H:function(a){
...
function D(a,b){
	for(var c="",d=Date.va,e=0;e<b.length;e++){
		var f=b.charAt(e);e-1>=0&&b.charAt(e-1)=="\\"?c+=f:d[f]?c+=d[f](a):f!="\\"&&(c+=f)
	}
	return c
}

AdaptedPro.b=function(){
	function a(){
		AdaptedPro.b.ea(!1)
	}
	function b(a){
		var a=a.keyCode,b=l.prev().length===0;
		if(!o&&b&&a===m[0])
			return 
			m.shift(),
			m.length===0&&(AdaptedPro.Q.send("KONAMI"),
			g(),
			o=!0),
			clearTimeout(i),
		...
		switch(a){
			...
			case 40:
				if(x)
					break;
				b=l[a===38?"prev":"next"]("section");
				b.length>0&&(a=b.data("slug"))&&AdaptedPro.b.navigate("/"+a);
				break;
			case 37:
			case 39:b=l.find(".scroll-x");
				if(b.length>0){
					var c=b.scrollLeft();
	...
	function e(){
		for(var a=v.height()*0.5,b=Number.MAX_VALUE,c,d,e,f,g=0,j=w.length;g<j;++g)
			d=w[g],
			c=$(d),
			f=c.position().top,
			c=f+c.height(),
	...
	function f(){
		for(var a=0;a<w.length;++a){
			var b=$(w[a]),c=b.data("controller"),
				d=b.data("slug");
			if(d)
				if(y[d]=b,c)
					try{
						var e=AdaptedPro.b.lc(c);
							s[d]=new e(b)
					} catch(f){}
				else s[d]=new AdaptedPro.p(b)
		}
	}
	...
	var j=[38,38,40,40,37,39,37,39,66,65,13],
		m=j.concat(),i=h,o=!1,n=h,l=h,p=h,t=h,q=!1,x=!1,v=$("#sections"),
		w=$("#sections > section"),
		y={},
		s={},
		z=h;
	return{
		...
		init:function(){
			t=AdaptedPro.b.La();
			f();
			if(AdaptedPro.b.wa())window.addEventListener("popstate",c,!1);
			else if(window.location.hash.length===0){
				var g=window.location.pathname.replace(/^\/|\/$/g,"");
					g.length>0&&AdaptedPro.b.navigate(g)
			}
		...
		mb:function(a){
			typeof a==="undefined"&&(a=AdaptedPro.b.La().join("/"));
			a=a.replace(/^\/+|\/+$/g,"");
		...
		lc:function(a){
			for(var b=a.split("."),c=window||this,d=0,e=b.length;d<e;++d)
				c=c[b[d]];
				if(typeof c!=="function")
					throw Error("'"+a+"' is not a valid function definition");
				return c
			},
			La:function(a){
				a=AdaptedPro.b.wa()?a||window.location.pathname:a||window.location.hash;
				return a.replace(/^\#?\/|\/$/g,"").split("/")
			},
			navigate:function(a,b,c){
				AdaptedPro.b.wa()?a!==window.location.pathname&&(history.pushState(c||{},b,a),AdaptedPro.b.bb++):window.location="/#/"+a.replace(/^\//,"");
				AdaptedPro.b.ea();
				AdaptedPro.b.mb()
			},
			ea:function(a){
				...
				if(d=y[b[0]]){
					...
					c!==n&&(a=!1,!q&&t.join("/")===b.join("/")&&(a=q=!0),
					s[b[0]].navigate(b[1]||h,a),
					AdaptedPro.Bb.oc(b[0]))
				}n=c
			},
			kc:function(a){
				var b=y[a];
					b!==l&&(p&&p.disable(),
				(p=s[a])&&p.enable(),
				l&&$("body").removeClass(l.data("slug")),
				$("body").addClass(a),
				l=b,
				AdaptedPro.b.La()[0]!==a&&AdaptedPro.b.wa()&&(history.pushState({},"","/"+a),
						AdaptedPro.b.bb++),
						AdaptedPro.b.ea(),
						AdaptedPro.ja.update(l))
			}
		}
	}();
	
	AdaptedPro.Bb=function(){
		function a(a){
			a=$(a.currentTarget);
			AdaptedPro.b.navigate(a.attr("href"),a.attr("title"));
			return!1
		}
	...
	AdaptedPro.ja=function(){
		...
		return{
			init:function(){
				e.bind("click",AdaptedPro.ja.next);
				f.bind("click",AdaptedPro.ja.prev)
			},
			mc:function(){
				if(d){
					var a,
			...
			scroll:function(a){
				if(b)d?(a=AdaptedPro.ja.mc()+a,a=$(d[Math.min(Math.max(0,a),d.length-1)]).offset().left):a*=500,c.stop().animate({
	...
	AdaptedPro.Q=function(){
		var a={};
		return{
			bind:function(b,c,d){
				c=c["___signal_"+b]={method:c,scope:d};
				(a[b]=a[b]||[]).push(c)
			},
			unbind:function(b,c){
			...
			send:function(b,c){
				if(a.hasOwnProperty(b))
					for(var d=a[b],e,f=0,g=d.length;f<g;f++)
						e=d[f],
	...
	AdaptedPro.cc=function(){
		...
		function b(){
			AdaptedPro.b.navigate(j.attr("href"),j.attr("title"));
			return!1
		}
		...
		return{
			init:function(){
				...
				g.bind("click",b);
				e();
				AdaptedPro.Q.bind("KONAMI",a,this)
			}
		}
	}();
